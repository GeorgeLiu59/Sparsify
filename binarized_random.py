...
class ImageProcessor(QMainWindow):
    def __init__(self):
        ...
        self.randomize_button.setFixedHeight(40)
        ...
        """)
        self.randomize_button.clicked.connect(self.process_image)
    ...
    def process_image(self):
        ...
        # Randomly select contours to remove
